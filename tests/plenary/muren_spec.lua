...
describe("muren cwd", function()
  ...
  --   feedkeys('V:MurenToggle<CR>')
  --   set_current_lines({'ffo\\+'})
  --   feedkeys('<Tab>')
  --   set_current_lines({'bbar'})
  --   -- NOTE we directly set the value since vim.ui.input seem tricky to emulate
  --   require('muren.options').values.cwd = true
  --   require('muren.options').values.files = '{a.txt,b.txt}'
  --   feedkeys('<CR>')
  --   feedkeys('q')
  --   vim.cmd.edit("a.txt")
  --   assert_current_lines({'bbar'})
